...
% Use this for your final thesis document. 
\usepackage{dcti}
% Use this instead for your yearly PhD reports.
...
% Jury (\\ breaks the line; ~\\ adds a blank line)
\jury{
...
\acronyms{
    ...
    % For "irregular" plurals, instead of \acp (which just appends an "s" at the end), you can define a custom plural using the \acroplural command. In this example, you wouldn't want QAYTs referring to "Question about your Thesiss"!
    \acro{QAYT}{Question About Your Thesis}
    \acroplural{QAYT}[QAYTs]{Questions About Your Thesis}
}
% =====================================================================
...
{
Palavras-chave; separadas; por; ponto-e-vírgula (de 3 a 6 palavras-chave)
}
...
{
Keywords; separated; by; semicolons (3 to 6 keywords)
}
% =====================================================================
